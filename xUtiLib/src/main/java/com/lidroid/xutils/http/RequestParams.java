...
public class RequestParams {
	...
	private HashMap<String, ContentBody> fileParams=new HashMap<String, ContentBody>();
	private String allKey;
	private List<String> filePath=new ArrayList<String>();
	private List<ContentBody> allBody=new ArrayList<ContentBody>();
	...
	public void addBodyParameter(String key, File file, String fileName,
	 ...
	 * @param filePath
	 */
	public void addBodyParameterS(String key, List<String> paths) {
		allKey = key;
		filePath = paths;
	}
	 ...
	 * @param filePath
	 */
	public void addBodyParameter(String key, List<ContentBody> bodys) {
		allKey = key;
		allBody = bodys;
	}
	...
	public HttpEntity getEntity() {
		...
		if ((allBody != null && !allBody.isEmpty()) || (fileParams != null && !fileParams.isEmpty()) 
			...
			for (ContentBody body : allBody) {
				multipartEntity.addPart(allKey, body);
			}
			for (String str : filePath) {
				multipartEntity.addPart(allKey, (ContentBody)new FileBody(new File(str)));
			}
