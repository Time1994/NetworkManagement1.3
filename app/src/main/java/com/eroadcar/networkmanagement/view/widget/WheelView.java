...
package com.eroadcar.networkmanagement.view.widget;
...
public class WheelView extends View {
     ...
     * Items text color
     */
    private static final int ITEMS_TEXT_COLOR = 0xffafb8a4;
    ...
    private void initData(Context context) {
        ...
        TEXT_SIZE = (int) getResources().getDimension(R.dimen.text_eightheen);
    }
