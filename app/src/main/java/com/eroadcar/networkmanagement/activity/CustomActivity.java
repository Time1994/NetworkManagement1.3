...
public class CustomActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        customClasss.add(1, "O");
        customClasss.add(2, "F");
        customClasss.add(3, "A");
        customClasss.add(4, "B");
        customClasss.add(5, "C");
        ...
        main_lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(CustomActivity.this, CustomDetailsActivity.class);
    ...
    private void getPotentialClient(String ptc_client_type, String ptc_level) {
        ...
        String url = Constant.GETPOTENTIALCLIENTFORUSER;
                    ...
                    if (qianKeBeans.getState().equals("success")) {
                        if (qianKeBeans.getData() == null
                            ...
                            main_lv.setAdapter(new QiankeAdapter(
                                    CustomActivity.this, qianKeBeans.getData(), "emplo"));
        ...
        if (city_pop_rl.isShown()) {
            ...
            if (type.equals("c")) {
                cxarrz_adapter = new ArrayAdapter<String>(
                        CustomActivity.this, R.layout.view_textview, customTypes);

                city_iv.setImageResource(R.mipmap.icon_sanjiao_up);
            } else {
                cxarrz_adapter = new ArrayAdapter<String>(
                        CustomActivity.this, R.layout.view_textview, customClasss);
