...
public class OrderSaleManagerAdapter extends BaseAdapter {
    private ArrayList<OrderSalesBean> mData;
    private Context mContext;


    public OrderSaleManagerAdapter(Context context, ArrayList<OrderSalesBean> data) {
    ...
    public View getView(int position, View convertView, ViewGroup arg2) {
        ...
        name.setText(position+1+"、"+"客户姓名：" + bean.getYfs_sellsq_ownner());
        state.setText(bean.getYfs_sellsq_state());
        empl.setText("提交人：" + bean.getYfs_sellsq_person());
        time.setText("提交时间：" + bean.getYfs_sellsq_time());
